...
@Entity
@Table(name = "urban_zone_permitted_use_g", schema = "public", catalog = "mgis")
@IdClass(UrbanZonePermittedUseGPK.class)
public class UrbanZonePermittedUseG {
    ...
    public boolean equals(Object o) {
        ...
        UrbanZonePermittedUseG that = (UrbanZonePermittedUseG) o;
