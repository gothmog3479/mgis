...
@Entity
@Table(name = "urban_zone_permitted_use_c", schema = "public", catalog = "mgis")
@IdClass(UrbanZonePermittedUseCPK.class)
public class UrbanZonePermittedUseC {
    ...
    public boolean equals(Object o) {
        ...
        UrbanZonePermittedUseC that = (UrbanZonePermittedUseC) o;
