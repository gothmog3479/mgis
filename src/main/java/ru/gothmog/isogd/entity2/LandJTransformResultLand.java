...
@Entity
@Table(name = "land_j_transform_result_land", schema = "public", catalog = "mgis")
public class LandJTransformResultLand {
    ...
    public boolean equals(Object o) {
        ...
        LandJTransformResultLand that = (LandJTransformResultLand) o;
